...
Nach der Gleichung \ref lässt sich der Wärmestrom $\frac{\Delta Q}{\Delta t}$ für die verschiedenen Metallstäbe errechnen (siehe Tabelle \ref{tab:Wärmestrom}).
Dabei wird für das $\kappa $ der Wert aus der Literatur genommen (siehe Vorbereitung \ref) und der Abstand $x$ der Tempertaurmessstellen wurde zu $x = \SI{0.03}{\metre}$ nachgemessen.
\begin{table}
  \centering
  ...
  \toprule
  &\multicolumn{4}{c}{$\frac{\Delta Q}{\Delta t} \mathbin{/} \si{\joule\per\second}$}\\
  \cmidrule(lr){2-5}
